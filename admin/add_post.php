...
<body>
        ...
        <div class="col-md-5 mx-auto">
            <div class="form-area">
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="desc" type="textarea" id="message" placeholder="Description"
                            rows="7"></textarea>
                    </div>
                    <input type="hidden" name="date" value="<?php echo date("d/m/y"); ?>">
                    <input type="hidden" name="author" value="<?php echo $un ?>">
                    <button type="submit" name="submit" class="btn btn-primary btn-block">Save</button>
                    <button class="btn btn-warning btn-block"><a href="home.php" style="text-decoration:none; color:white">Back to Home</a></button>
                </form>
            </div>
        </div>
    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        echo "<script>alert('Post Saved'); window.location.href='add_post.php';</script>";
    }
    ?>
