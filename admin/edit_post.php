...
$res1=mysqli_query($conn,"select * from post  LEFT JOIN category ON post.category=category.cate_id where post.id='$post_id'");
 ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<center>
	<div class="container">
		<div class="col-md-5" style="margin-left: 0; padding: 15px;">
			<div class="form-area">
				<form role="form" method="post" enctype="multipart/form-data">
					<h3 style="margin-bottom: 15px; text-align: center;">Edit Post</h3>
					<?php while ($rs1 = mysqli_fetch_array($res1)) { ?>
						...
						<div class="form-group">
							<select class="form-control" name="category">
								<option><?php echo $rs1['name']; ?></option>
								<?php 
						...
						<div class="form-group">
							...
							<img src="image/<?php echo $rs1['photo']; ?>" width="150px" height="100px">
						</div>
						<input type="hidden" name="date" value="<?php echo $rs1['date']; ?>">
						<input type="hidden" name="author" value="<?php echo $un ?>">
					<?php } ?>
					<button type="submit" name="submit" class="btn btn-primary btn-block">Update</button>
					<button class="btn btn-warning btn-block"><a href="post.php" style="text-decoration:none; color:white">Back to Home</a></button>
				</form>
			</div>
		</div>
	</div>
